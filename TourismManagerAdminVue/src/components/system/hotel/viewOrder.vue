      ...
      <el-row :gutter="10">
        <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
            ...
            <el-form-item prop="hotelId" style="margin-bottom:0">
                <el-input v-model="form.hotelId"   placeholder="请输入酒店id" autocomplete="off"></el-input>
            </el-form-item>
        </el-col>
        <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
            <span class="search-title">
        ...
        <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
            ...
            <el-form-item prop="itemId" style="margin-bottom:0">
                <el-input v-model="form.itemId"   placeholder="请输入房型id" autocomplete="off"></el-input>
            </el-form-item>
        </el-col>
        <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
            <span class="search-title">
            ...
            <el-form-item prop="itemName" style="margin-bottom:0">
                <el-input v-model="form.itemName"   placeholder="请输入房型" autocomplete="off"></el-input>
            </el-form-item>
        </el-col>
        <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
            <span class="search-title">
            ...
            <el-form-item prop="price" style="margin-bottom:0">
                <el-input v-model="form.price"   placeholder="请输入价格" autocomplete="off"></el-input>
            </el-form-item>
        </el-col>
      </el-row>
    </el-form>
