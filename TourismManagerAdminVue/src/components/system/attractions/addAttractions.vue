        ...
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            ...
            <div style="width:100%">
                <el-form-item prop="price" style="margin-bottom:0">
                    <el-input type="number" v-model="form.price"   placeholder="请输入价格" autocomplete="off"></el-input>
                </el-form-item>
            </div>
        </el-col>
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            ...
            <div style="width:100%">
                <el-form-item prop="introduce" style="margin-bottom:0">
                    <el-input type="textarea" v-model="form.introduce"   placeholder="请输入简介" autocomplete="off"></el-input>
                </el-form-item>
            </div>
        </el-col>
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            ...
            <div style="width:100%">
                <el-form-item prop="content" style="margin-bottom:0">
                    <el-input type="textarea" v-model="form.content"   placeholder="请输入介绍" autocomplete="off"></el-input>
                </el-form-item>
            </div>
        </el-col>
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            ...
            <div style="width:100%">
                <el-form-item prop="num" style="margin-bottom:0">
                    <el-input type="number" v-model="form.num"   placeholder="请输入库存" autocomplete="off"></el-input>
                </el-form-item>
            </div>
        </el-col>
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
        ...
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            ...
            <div style="width:100%">
                <el-form-item prop="open" style="margin-bottom:0">
                    <el-input type="textarea" v-model="form.open"   placeholder="请输入预约须知" autocomplete="off"></el-input>
                </el-form-item>
            </div>
        </el-col>
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            ...
            <div style="width:100%">
                <el-form-item prop="time" style="margin-bottom:0">
                    <el-input type="textarea" v-model="form.time"   placeholder="请输入入园时间" autocomplete="off"></el-input>
                </el-form-item>
            </div>
        </el-col>
      </el-row>
