<template>
<div>
  <el-dialog title="编辑旅游线路" width="40%" :destroy-on-close="true" :visible.sync="updateVisible" :before-close="handleClose">
        ...
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            ...
            <div style="width:100%">
                <el-form-item prop="temperature" style="margin-bottom:0">
                    <el-input type="number" v-model="form.temperature"   placeholder="请输入温度" autocomplete="off"></el-input>
                </el-form-item>
            </div>
        </el-col>
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            ...
            <div style="width:100%">
                <el-form-item prop="geography" style="margin-bottom:0">
                    <el-input v-model="form.geography"   placeholder="请输入地理情况" autocomplete="off"></el-input>
                </el-form-item>
            </div>
        </el-col>
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            ...
            <div style="width:100%">
                <el-form-item prop="introduce" style="margin-bottom:0">
                    <el-input type="textarea" v-model="form.introduce"   placeholder="请输入介绍" autocomplete="off"></el-input>
                </el-form-item>
            </div>
        </el-col> 
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
...
<script>
  ...
  import {editSysLine,getSysLineById} from '../../../api/api'
  export default {
    mixins: [mixin],
    data() {
      return{
    ...
    watch: {
      updateId(newVal) {
        if(newVal) {
          getSysLineById({id:newVal}).then(res => {
            if(res.code == 1000) {
              this.form = res.data
