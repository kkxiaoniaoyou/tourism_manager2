          ...
          <div>
            <el-dropdown  trigger="click" @command="handleCommand">
              <span class="el-dropdown-link">
                <img style="width:40px;height:40px;border-radius:50%;object-fit: cover;" :src="$store.state.configure.HOST + user.avatar"/>
              </span>
              <el-dropdown-menu slot="dropdown" style="font-weight:bold">
                <el-dropdown-item command="password"><i class="iconfont icon-r-lock" ></i>修改密码</el-dropdown-item>
                <el-dropdown-item divided style="color:red" command="logout"><i class="iconfont icon-r-no"></i>退出</el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
          </div>
        </div>
