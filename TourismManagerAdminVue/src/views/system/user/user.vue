    ...
    <div class="search-table">
        <div class="search">
            <!-- <el-row :gutter="10" style="padding:10px">
                ...
                <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
                    ...
                    <el-select clearable style="margin-top:10px"   v-model="search.status" placeholder="请选择">
                      <el-option
                        label="正常"
                        value="0">
                      </el-option>
                ...
                <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
                    <el-button style="margin-top:10px"     type="primary" @click="query">查询</el-button>
        ...
        <div class="table">
            <el-row style="padding-top:10px;margin-left:10px">
                ...
                <!-- <el-button type="success" :disabled="update.length != 1 ?true:false"     plain @click="updateUserBtn">修改</el-button> -->
            </el-row>
            <el-table
            :data="tableData"
            :header-cell-style="{
  ...
  <template slot-scope="scope">
                <el-dropdown trigger="hover" @command="handleCommand">
                  ...
                  <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item   :command="scope.row.id + '#edit'">修改</el-dropdown-item>
...
<el-pagination background layout="total, prev, pager, next" :page-sizes="[20, 30, 50, 100]" :page-size="search.pageSize"
  :current-page="search.pageNumber" @size-change="handleSizeChange" @current-change="handleCurrentChange"
  :total="total">
</el-pagination>
</div>
</div>
<add-user @addUserFalse="addUserFalse" :addUserVisible="addUserVisible"></add-user>
<update-user @updateUserFalse="updateUserFalse" :updateId="updateId"
  :updateUserVisible="updateUserVisible"></update-user>
<el-dialog title="重置密码" :visible.sync="passwordDialogVisible" width="30%" :before-close="handlePasswordClose">
  <span>请输入{{userName}}的新密码：</span>
  <el-input style="margin-top:10px" show-password v-model="newPassword"   autocomplete="off"></el-input>
  <span slot="footer" class="dialog-footer">
    <el-button   @click="handlePasswordClose">取 消</el-button>
