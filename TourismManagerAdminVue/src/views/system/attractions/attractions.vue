      ...
      <div class="search-table">
        <div class="search">
            <el-row :gutter="10" style="padding:10px">
                ...
                <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
                    <el-button style="margin-top:10px"     type="primary" @click="searchPage">查询</el-button>
        ...
        <div class="table">
            <el-row style="padding-top:10px;margin-left:10px">
                ...
                <el-button type="success" :disabled="update.length != 1 ?true:false"     plain @click="updateDataBtn">修改</el-button>
                <el-button type="danger" :disabled="update.length <= 0 ?true:false"     plain @click="deleteDataBtn">删除</el-button>
            </el-row>
            <el-table
            v-loading="loading"
            :data="tableData"
            ...
            <el-table-column
              ...
              >
              <template slot-scope="scope">
                <el-button   type="info" v-if="scope.row.state == 0" @click="toEdit(scope.row.id,1)">上架</el-button>
                <el-button   type="info" v-if="scope.row.state == 1" @click="toEdit(scope.row.id,0)">下架</el-button>
                <el-button   type="primary" @click="toComment(scope.row.id)">评论</el-button>
