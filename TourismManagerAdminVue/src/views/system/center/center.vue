            ...
            <div class="master">
              <el-form style="margin-right:20px" :model="user" :rules="rules" ref="ruleForm" label-width="140px">
                <el-form-item label="登陆账号" prop="loginAccount">
                  <el-input   disabled v-model="user.loginAccount"></el-input>
                </el-form-item>
                ...
                <el-form-item label="登陆IP" prop="loginIp">
                  <el-input   disabled v-model="user.loginIp"></el-input>
                </el-form-item>
                <el-form-item label="登陆时间" prop="loginDate">
                  <el-input   disabled v-model="user.loginDate"></el-input>
                </el-form-item>
                <el-form-item label="上次修改密码时间" prop="pwdUpdateDate">
                  <el-input   disabled v-model="user.pwdUpdateDate"></el-input>
                </el-form-item>
              </el-form>
              <div class="submit">
                ...
                <div class="btns">
                  <div>
                    <el-upload
                      ...
                      accept="image/*"
                      >
                      <el-button   icon="el-icon-picture-outline-round">修改头像</el-button>
                    </el-upload>
                  </div>
                  <div style="margin-top:15px">
                    <el-button   icon="el-icon-key" @click="changePassword">修改密码</el-button>
                  </div>
                </div>
            </div>
        </div>
