  ...
  <div class="attractions">
    ...
    <div class="attractions1">
      <div class="attractions2">
        <el-input  style="width:300px;margin-left:20px" v-model="search.name" placeholder="请输入景点名称"></el-input>
      ...
      <div class="attractions3">
        <div class="index5" v-for="(item,index) in tableData" :key="index" style="margin-top:15px">
          ...
          <div class="index6">
            ...
            <button class="index9" @click="toInfo(item.id)" style="margin-bottom:10px;cursor: pointer;margin-top:10px">
              预 约
            </button>
          </div>
        </div>
